...
const generateSummonStatistics = (pulls: SummonPulls): SummonStatistics => {
  ...
  statistics.totals = new SummonStatisticsItem(
    pulls.normal.total + pulls.faction.total + pulls.companion.total + pulls.heroChoice.total + pulls.stargazer.total + pulls.timeTemple.total + pulls.furniture.total + pulls.cards.total,
    pulls.normal.normal.length + pulls.faction.normal.length + pulls.companion.normal.length + pulls.heroChoice.normal.length + pulls.stargazer.normal.length + pulls.timeTemple.normal.length + pulls.furniture.normal.length + pulls.cards.normal.length,
    pulls.normal.celepogean.length + pulls.faction.celepogean.length + pulls.companion.celepogean.length + pulls.heroChoice.celepogean.length + pulls.stargazer.celepogean.length + pulls.timeTemple.celepogean.length + pulls.furniture.celepogean.length + pulls.cards.celepogean.length,
    pulls.normal.awakened.length + pulls.faction.awakened.length + pulls.companion.awakened.length + pulls.heroChoice.awakened.length + pulls.stargazer.awakened.length + pulls.timeTemple.awakened.length + pulls.furniture.awakened.length + pulls.cards.awakened.length,
    pulls.normal.mythicFurniture.length + pulls.faction.mythicFurniture.length + pulls.companion.mythicFurniture.length + pulls.heroChoice.mythicFurniture.length + pulls.stargazer.mythicFurniture.length + pulls.timeTemple.mythicFurniture.length + pulls.furniture.mythicFurniture.length + pulls.cards.mythicFurniture.length,
    pulls.normal.cardHero.length + pulls.faction.cardHero.length + pulls.companion.cardHero.length + pulls.heroChoice.cardHero.length + pulls.stargazer.cardHero.length + pulls.timeTemple.cardHero.length + pulls.furniture.cardHero.length + pulls.cards.cardHero.length,
    pulls.normal.cardFurniture.length + pulls.faction.cardFurniture.length + pulls.companion.cardFurniture.length + pulls.heroChoice.cardFurniture.length + pulls.stargazer.cardFurniture.length + pulls.timeTemple.cardFurniture.length + pulls.furniture.cardFurniture.length + pulls.cards.cardFurniture.length,
  );
  return statistics;
};
