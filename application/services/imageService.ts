...
const equipT4StrWeapon = require('~/assets/images/items/equipment/t4/str/weapon.jpg');
const equipT4StrHead = require('~/assets/images/items/equipment/t4/str/head.jpg');
const equipT4StrChest = require('~/assets/images/items/equipment/t4/str/chest.jpg');
const equipT4StrFeet = require('~/assets/images/items/equipment/t4/str/feet.jpg');
const equipT4DexWeapon = require('~/assets/images/items/equipment/t4/dex/weapon.jpg');
const equipT4DexHead = require('~/assets/images/items/equipment/t4/dex/head.jpg');
const equipT4DexChest = require('~/assets/images/items/equipment/t4/dex/chest.jpg');
const equipT4DexFeet = require('~/assets/images/items/equipment/t4/dex/feet.jpg');
const equipT4IntWeapon = require('~/assets/images/items/equipment/t4/int/weapon.jpg');
const equipT4IntHead = require('~/assets/images/items/equipment/t4/int/head.jpg');
const equipT4IntChest = require('~/assets/images/items/equipment/t4/int/chest.jpg');
const equipT4IntFeet = require('~/assets/images/items/equipment/t4/int/feet.jpg');

const equipStoneStrT1 = require('~/assets/images/items/equipment/stones/stone-str-t1.jpg');
const equipStoneStrT2 = require('~/assets/images/items/equipment/stones/stone-str-t2.jpg');
const equipStoneStrT3 = require('~/assets/images/items/equipment/stones/stone-str-t3.jpg');
const equipStoneStrT4 = require('~/assets/images/items/equipment/stones/stone-str-t4.jpg');
...
const equipStoneDexT4 = require('~/assets/images/items/equipment/stones/stone-dex-t4.jpg');
...
const equipStoneIntT4 = require('~/assets/images/items/equipment/stones/stone-int-t4.jpg');
